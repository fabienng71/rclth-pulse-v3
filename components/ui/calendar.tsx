...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 pointer-events-auto relative z-50", className)}
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 pointer-events-auto hover:bg-accent hover:text-accent-foreground"
        ),
