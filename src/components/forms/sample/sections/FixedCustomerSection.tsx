...
interface FixedCustomerSectionProps {
  customerCode: string;
  customerName: string;
...
const FixedCustomerSection = ({
  customerCode,
  customerName,
  onSelectCustomer,
  onClearCustomer
}: FixedCustomerSectionProps) => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Search and select the customer for this sample request
        </p>
      </div>
...
export default FixedCustomerSection;
